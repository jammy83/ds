...
#ifndef ____SortedArray__
#define ____SortedArray__
...
// The type of the search performed on the sorted array
typedef enum {
    LessThan = 0,
    LessThanEquals = 1,
    Equals = 2,
    GreaterThanEquals = 3,
    GreaterThan = 4,
    NumSearchTypeEntries = 5 // make sure this is the last entry
} SearchType;

// The type of result returned after the search on the sorted array
typedef enum {
    NotFound,
    FoundExact,
    FoundGreater,
    FoundLess,
    NumSearchResultEntries // make sure this is the last entry
} SearchResult;
...
#endif /* defined(____SortedArray__) */
